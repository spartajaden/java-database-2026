...
![image](/attachments/card-1773108854038/paste_1773109502287_ropnr.png)
...
1. 로컬 설치
    ...
    ![image](/attachments/card-1773108854038/paste_1773109531104_m3tz1.png)

2. 도커 설치(클라우드 동일)

    ![image](/attachments/card-1773108854038/paste_1773109558373_n5u18.png)
...
2. Docker Command 사용
    ...
    - 이미지 당겨오기
        ...
        ![image](/attachments/card-1773108854038/paste_1773109579922_8arnm.png)
    ...
    - 컨테이너 실행
        ...
        ![image](/attachments/card-1773108854038/paste_1773109592486_dviox.png)
...
3. VS Code 확장
    - Database Client, Database Client JDBC 확장 설치
        ...
        ![image](/attachments/card-1773108854038/paste_1773109630979_dh1hc.png)

### DBeaver 사용법

- Database Navigator 에서 DB연결 시작

    ![image](/attachments/card-1773108854038/paste_1773109645394_aej8t.png)

    - 마우스 오른쪽 버튼 > Create > Connection

        ![image](/attachments/card-1773108854038/paste_1773109656482_pes5i.png)
    
    - 연결정보 입력 Test Connection
    - 입력 시 주의사항 : Port번호 확인, Database 이름변경 Oracle -> XE로, Username, Password 일치

        ![image](/attachments/card-1773108854038/paste_1773109667170_8i7ny.png)
...
- DBeaver
    ...
    - 폰트 변경: 메뉴 윈도우 > 환경 설정
        - User Interface > 모양 > 색상 및 글꼴 > DBeaver Fonts > Monospace font
            ...
            ![image](/attachments/card-1773108854038/paste_1773109677679_vruxf.png)

- 샘플 데이터베이스 생성
    1. 테이블 생성 : 1.sample_schemas.sql
    2. 시퀀스 생성 : 2.sequences.sql
    3. 부서데이터 추가 : 3.department_datas.sql
    4. 직원데이터 추가 : 4.employee_datas.sql
    5. 고객데이터 추가 : 5.customer_datas.sql
    6. 상품데이터 추가 : 6.product_datas.sql
    7. 주문과 주문상세데이터 추가 : 7.order_order_item_datas.sql
...
![image](/attachments/card-1773109714393/paste_1773109745327_tfcfg.png)
...
- 데이터 조회 3가지 방법 - 1.how_to_look_up_data.sql
    - 셀렉션 - 행단위로 조회
    - 프로젝션 - 열단위로 조회
    - 조인 - 두 개 이상 테이블을 조합해서 조회

- SELECT 문법
    - 기본쿼리, 별명 - 2.기본쿼리 및 별명지정쿼리.sql
    - 중복제거 - 3.중복제거쿼리.sql
    - 정렬 - 4.정렬쿼리.sql
    - WHERE절 - 5.조건쿼리.sql
...
- SELECT 연산 - 6.연산자.sql
 ...
 - 오라클 함수 : DB별로 추가학습 필요 - 8.오라클함수.sql
    - 문자열 함수
...
![image](/attachments/card-1773109925850/paste_1773109954289_mpjnl.png)
...
- DML
    ...
    - `UPDATE` - 데이터 수정 - 2.UPDATE_DELETE.sql
...
- 트랜잭션 설정 - Oracle은 트랜잭션을 시작하는 `BEGIN TRAN[SACTION]`이 없음
    ...
    - DBeaver의 경우 메뉴 데이터베이스 > 트랜잭션 모드 > `Manual Commit`으로 변경
        ...
        ![image](/attachments/card-1773109975619/paste_1773110011554_1fx41.png)

    - 환경 설정 > 연결 > 연결 유형 > `Auto-commit by default`를 해제

        ![image](/attachments/card-1773109975619/paste_1773110022335_dtmud.png)
...
- 사용자 권한
    ...
    ![image](/attachments/card-1773111588362/paste_1773111661395_wxjka.png)
...
- 예외처리 - 6.예외처리.sql
 ...
 ![image](/attachments/card-1773111588362/paste_1773111716792_fm348.png)
...
- PROCEDURES
   ...
   ![image](/attachments/card-1773278956472/paste_1773279163473_yugv8.png)
...
- 메뉴 > 데이터베이스 > 커밋, 롤백, 트랜잭션 모드는 DB에 맞게 잘 사용할 것
    ...
    ![image](/attachments/card-1773278956472/paste_1773279190554_i4yol.png)
...
- 개념 데이터 모델링
   ...
   ![image](/attachments/card-1773278956472/paste_1773279351330_m8vtn.png)
...
![image](/attachments/card-1773278956472/paste_1773279386193_ymebq.png)
...
![image](/attachments/card-1773278956472/paste_1773279770240_sccer.png)
...
- 종류
    ...
    - Draw.io - [링크](https://app.diagrams.net/) 무료. 다양한 다이어그램. sql 변환 불가
    - `erdcloud` - [링크](https://www.erdcloud.com/) 모델링에 물리 스키마까지 생성가능한 한국어 지원도구
...
- 회원가입 후 로그인
 ...
 1. ERD 생성 클릭
  ...
  ![image](/attachments/card-1773280180996/paste_1773280636638_073vj.png)

 2. 새로운 엔티티 추가
  - 노란색 + : 키 추가
  - 하늘색 + : 컬럼 추가

 ![image](/attachments/card-1773280180996/paste_1773280668543_kytbg.png)
...
3. 관계(없거나 한개 또는 여러개) 클릭
  ...
  ![image](/attachments/card-1773280180996/paste_1773280718687_pzp8b.png)

  - 결과
 ![image](/attachments/card-1773280180996/paste_1773280743539_z14rl.png)


4. 각 엔티티와 키와 속성 관계로 논리 다이어그램 작성
 
![image](/attachments/card-1773280180996/paste_1773280788754_29ryz.png)


5. 물리 다이어그램으로 변경 작성. 각 데이터 타입 수정

![image](/attachments/card-1773280180996/paste_1773280816375_pc9h5.png)


6. 내보내기 클릭 - 3.병원물리스키마_비식별관계.sql
 - DB 종류 선택 - 현재 Oracle
 - PK 제약조건, FK 제약조건, 비식별 제약조건 추가 선택
 - SQL 미리보기 클릭 후, 미리보기 복사

 ![image](/attachments/card-1773280180996/paste_1773280878002_4larc.png)


7. DB 툴에서 복사한 쿼리로 실행

![image](/attachments/card-1773280180996/paste_1773280902484_bcws3.png)
...
![image](/attachments/card-1773280180996/paste_1773280923780_8pfwt.png)
